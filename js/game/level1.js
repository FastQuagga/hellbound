...
export const LEVEL1 = {
  ...
  walls: [
    '################################################################',
    '#KKKKKKKKKKKKKKKKKKKKKKKKKKQKKKKKKKKKKKQKKKKKK##################',
    '#KAAAAWAAAAAWAAAAAAAA........................K##################',
    '#KAA.............AAAA........................K#####...##...#####',
    '#KAA.............A...........................K#####...##...#####',
    ...
    '#KAA.............A........FFF................K..P............t##',
    '#KAA.............AAAA.....FFF................K..D............t##',
    '#KAAAAAAAWAAAAAAAAAAA........................K..P............t##',
    '#K...........................................K##t............t##',
    '#K...........................................K##t............t##',
    '#K...........................................K##tttttPDPtttttt##',
    '#K...........................................K########..########',
    '#KKKKKKKKKKKKKKKKKKKKKKKKKKKQKKKKKK...KKKKKKKK########..########',
    '##################################K...K##############G..########',
    '##################################K...K###############..N#######',
    '##################################K...K########MMMMMMM..MMMMMM##',
  ...
  wallLegend: {
    ...
    // — настенные панно (эксперимент: пропсы), база совпадает с соседней стеной —
    'G': { kind: 'wall', tex: 'PAINT_TECH' },  // панель-экран со схемой базы (на TECH1)
    'U': { kind: 'wall', tex: 'PAINT_UAC' },   // плакат корпорации UAC (на TECH1)
    'N': { kind: 'wall', tex: 'VENT' },        // вентиляционная решётка (на TECH1)
    'W': { kind: 'wall', tex: 'PAINT_DEMON' }, // адский триптих (на MARBLE)
    'Q': { kind: 'wall', tex: 'PAINT_PENTA' }, // пентаграмма (на BRICKRED)
  },
  ...
  things: [
    ...
    // ================= декор-пропсы (эксперимент: пропсы) =================
    // — стартовая комната —
    { type: 'blood_pool', x: 5.5, y: 55.5 },
    { type: 'cable_coil', x: 12.5, y: 60.5 },
    // — тёмный коридор A —
    { type: 'shells_spent', x: 17.5, y: 56.5 },
    { type: 'blood_pool', x: 19.5, y: 56.5 },
    { type: 'lamp_red', x: 22.5, y: 57.5 },
    // — секрет №1 —
    { type: 'candle', x: 19.5, y: 61.5 },
    // — склад —
    { type: 'crate_small', x: 33.5, y: 52.5 },
    { type: 'crate_small', x: 28.5, y: 59.5 },
    { type: 'shells_spent', x: 38.5, y: 56.5 },
    { type: 'rubble', x: 42.5, y: 51.5 },
    { type: 'cable_coil', x: 26.5, y: 57.5 },
    { type: 'blood_pool', x: 31.5, y: 56.5 },
    { type: 'monitor_broken', x: 25.5, y: 53.5 },
    // — двор под небом —
    { type: 'rubble', x: 28.5, y: 36.5 },
    { type: 'rubble', x: 44.5, y: 42.5 },
    { type: 'bones', x: 30.5, y: 44.5 },
    { type: 'blood_pool', x: 36.5, y: 41.5 },
    // — коридор C и синее крыло —
    { type: 'blood_pool', x: 12.5, y: 41.5 },
    { type: 'shells_spent', x: 13.5, y: 38.5 },
    { type: 'monitor_broken', x: 6.5, y: 46.5 },
    // — секрет №2 —
    { type: 'candle', x: 2.5, y: 40.5 },
    // — машинный зал —
    { type: 'cable_coil', x: 29.5, y: 21.5 },
    { type: 'shells_spent', x: 35.5, y: 28.5 },
    { type: 'monitor_broken', x: 44.5, y: 20.5 },
    { type: 'blood_pool', x: 30.5, y: 30.5 },
    // — хранилище за красной дверью —
    { type: 'crate_small', x: 22.5, y: 27.5 },
    // — коридор E (фликер) —
    { type: 'cable_coil', x: 44.5, y: 24.5 },
    // — кислотный резервуар (кости у кислоты) —
    { type: 'bones', x: 49.5, y: 22.5 },
    { type: 'bones', x: 60.5, y: 29.5 },
    { type: 'rubble', x: 49.5, y: 31.5 },
    // — коридор G —
    { type: 'rubble', x: 55.5, y: 15.5 },
    // — комната жёлтого ключа (ловушка) —
    { type: 'shells_spent', x: 53.5, y: 9.5 },
    { type: 'blood_pool', x: 57.5, y: 10.5 },
    { type: 'monitor_broken', x: 60.5, y: 12.5 },
    { type: 'lamp_red', x: 50.5, y: 7.5 },
    // — адская зона —
    { type: 'skull_pile', x: 22.5, y: 12.5 },
    { type: 'skull_pile', x: 40.5, y: 5.5 },
    { type: 'skull_pile', x: 3.5, y: 14.5 },
    { type: 'gore_hang', x: 29.5, y: 8.5 },
    { type: 'gore_hang', x: 36.5, y: 7.5 },
    { type: 'hanging_chain', x: 33.5, y: 11.5 },
    { type: 'hanging_chain', x: 21.5, y: 10.5 },
    { type: 'blood_pool', x: 20.5, y: 8.5 },
    { type: 'bones', x: 26.5, y: 4.5 },
    { type: 'bones', x: 8.5, y: 12.5 },
    // — зал барона —
    { type: 'candle', x: 5.5, y: 3.5 },
    { type: 'candle', x: 5.5, y: 9.5 },
    { type: 'candle', x: 12.5, y: 3.5 },
    { type: 'skull_pile', x: 15.5, y: 8.5 },
  ],
};
